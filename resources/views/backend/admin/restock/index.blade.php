                ...
                <form method="post" method="post" action="{{route('restock.store')}}" class="form-horizontal">
                    ...
                    <div id="app">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="harga[]"
                                               :value="product_price(order.pesanan, index)">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <input type="number" name="jumlah[]" class="form-control"
                                               value="{{old('jumlah')}}" id="inputJumlah" placeholder="ex: 2"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input type="number" name="jumlah2[]" class="form-control"
                                               value="{{old('jumlah2')}}" id="inputJumlah2" placeholder="ex: 2"
                                               v-model="order.jumlah2" required="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <input type="text" name="subtotal[]" class="form-control" readonly
                                               ...
                                               :value="subtotal(order.jumlah2, order.jumlah, index)">
                        ...
                        <div style="text-align: center; font-size: 24px;" class="row">
                            <div class="col-md-12">
                                <input type="hidden" name="discount" class="form-control" v-model="discount"
                                       required="">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($row->status == 0 && auth()->user()->level == 'Owner')
                                            <form action="{{route('restock.status',$row->id)}}" method="post"
                                                  role="form">
                                                {{ csrf_field() }}
                                                {{ method_field('PATCH')}}
                                    ...
                                    <td>
                                        @if($row->status == 2)
                                            <form action="{{route('restock.stock',$row->id)}}" method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('PATCH')}}
                                                <input value="{{$row->stock}}" type="hidden" name="stock"
                                                       class="form-control" placeholder="Masukkan Kode Inventaris">
                                                <input value="{{$row->quantity}}" type="hidden" name="hasil"
                                                       class="form-control" placeholder="Masukkan Kode Inventaris">
                                                <input value="{{$row->product_name}}" type="hidden" name="barang"
                                                       class="form-control" placeholder="Masukkan Kode Inventaris">
                                                <input value="{{$row->lokasi}}" type="hidden" name="lokasi"
                                                       class="form-control" placeholder="Masukkan Kode lokasi">
                                                <input value="{{$row->id_produk}}" type="hidden" name="product_id"
                                                       class="form-control" placeholder="Masukkan Kode Inventaris">
                                    ...
                                    <td>
                                        @if((auth()->user()->level == 'Owner') or (auth()->user()->level == 'Purchase') )
                                            <form id="data-{{ $row->id }}"
                                                  action="{{route('restock.destroy',$row->id)}}" method="post">
                                                {{csrf_field()}}
                                                {{method_field('delete')}}
                                            </form>
                                            @csrf
                                    ...
                                    @if(($teling->user_id) == (auth()->user()->id))
                                        @if(($row->lokasi) == ($teling->nama_cabang))
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    @if($row->status == 0 && auth()->user()->level == 'Owner')
                                                        <form action="{{route('restock.status',$row->id)}}"
                                                            ...
                                                            <input value="1" type="hidden" name="status"
                                                                   class="form-control"
                                                                   placeholder="Masukkan Kode Inventaris">
                                                            <button type="submit" class="label bg-red">Konfirmasi
                                                            </button>
                                                        </form>
                                                    @elseif($row->status == 1 && auth()->user()->level == 'Owner')
                                                        <span class="label bg-blue">Pengiriman</span>
                                                    ...
                                                    @elseif($row->status == 1 && auth()->user()->level == 'Admin')
                                                        <form action="{{route('restock.status',$row->id)}}"
                                                            ...
                                                            <input value="2" type="hidden" name="status"
                                                                   class="form-control"
                                                                   placeholder="Masukkan Kode Inventaris">
                                                            <button type="submit" class="label bg-red">Terima Barang
                                                            </button>
                                                        </form>
                                                    @elseif($row->status == 2 && auth()->user()->level == 'Owner')
                                                        <span class="label bg-green">Barang diterima</span>
                                                ...
                                                @if($row->status == 2)
                                                    <td>
                                                        <form action="{{route('restock.stock',$row->id)}}"
                                                              method="post">
                                                            {{ csrf_field() }}
                                                            {{ method_field('PATCH')}}
                                                            <input value="{{$row->stock}}" type="hidden" name="stock"
                                                            ...
                                                            <input value="{{$row->quantity}}" type="hidden" name="hasil"
                                                                   class="form-control"
                                                                   placeholder="Masukkan Kode Inventaris">
                                                            <input value="{{$row->product_name}}" type="hidden"
                                                                   name="barang" class="form-control"
                                                                   placeholder="Masukkan Kode Inventaris">
                                                            <input value="{{$row->id_produk}}" type="hidden"
                                                            ...
                                                            <input value="3" type="hidden" name="status"
                                                                   class="form-control"
                                                                   placeholder="Masukkan Kode Inventaris">
                                                            <input value="{{$row->product_price}}" type="hidden"
                                                    ...
                                                    <td>
                                                        @if((auth()->user()->level == 'Owner') or (auth()->user()->level == 'Purchase') )
                                                            <form id="data-{{ $row->id }}"
                                                                  action="{{route('restock.destroy',$row->id)}}"
                                                                  method="post">
                                                                {{csrf_field()}}
                                                                {{method_field('delete')}}
                                                            </form>
                                                ...
                                                @elseif($row->status <= 2)
                                                    ...
                                                    <td>
                                                        @if((auth()->user()->level == 'Owner') or (auth()->user()->level == 'Purchase') )
                                                            <form action="{{route('restock.destroy',$row->id)}}"
                                                                  method="post">
                                                                @csrf
                                                                @method('DELETE')
