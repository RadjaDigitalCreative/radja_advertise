...
//        ASIAONE
        Route::get('/prospek/jenis_penawaran', 'Asiaone\JenisPenawaranController@index')->name('prospek.jenis_penawaran');
        Route::get('/prospek/jenis_penawaran/create', 'Asiaone\JenisPenawaranController@create')->name('prospek.jenis_penawaran.create');
        Route::post('/prospek/jenis_penawaran/store', 'Asiaone\JenisPenawaranController@store')->name('prospek.jenis_penawaran.store');
        Route::delete('/prospek/jenis_penawaran/delete/{id}', 'Asiaone\JenisPenawaranController@delete')->name('prospek.jenis_penawaran.delete');

        Route::get('/prospek/surat_penawaran', 'Asiaone\SuratPenawaranController@index')->name('prospek.surat_penawaran');
        Route::get('/prospek/surat_penawaran/create', 'Asiaone\SuratPenawaranController@create')->name('prospek.surat_penawaran.create');
        Route::post('/prospek/surat_penawaran/store', 'Asiaone\SuratPenawaranController@store')->name('prospek.surat_penawaran.store');
        Route::delete('/prospek/surat_penawaran/delete/{id}', 'Asiaone\SuratPenawaranController@delete')->name('prospek.surat_penawaran.delete');

        Route::get('/prospek/project', 'Asiaone\ProjectController@index')->name('prospek.project');
        Route::get('/prospek/project/create', 'Asiaone\ProjectController@create')->name('prospek.project.create');
        Route::post('/prospek/project/store', 'Asiaone\ProjectController@store')->name('prospek.project.store');
        Route::get('/prospek/project/show/{id}', 'Asiaone\ProjectController@show')->name('prospek.project.show');
        Route::get('/prospek/project/showPDF/{id}', 'Asiaone\ProjectController@showPDF')->name('prospek.project.showPDF');
        Route::get('/prospek/project/printPDF/{id}', 'Asiaone\ProjectController@printPDF')->name('prospek.project.printPDF');
        Route::get('/prospek/project/edit/{id}', 'Asiaone\ProjectController@edit')->name('prospek.project.edit');
        Route::post('/prospek/project/update', 'Asiaone\ProjectController@update')->name('prospek.project.update');
        Route::delete('/prospek/project/delete/{id}', 'Asiaone\ProjectController@delete')->name('prospek.project.delete');
        Route::delete('/prospek/project/deal/{id}', 'Asiaone\ProjectController@deal')->name('prospek.project.deal');
        Route::post('/prospek/project/saveDeal', 'Asiaone\ProjectController@saveDeal')->name('prospek.project.saveDeal');

        Route::get('/prospek/deal', 'Asiaone\DealController@index')->name('prospek.deal');
        Route::get('/prospek/deal/show/{id}', 'Asiaone\DealController@show')->name('prospek.deal.show');
        Route::get('/prospek/deal/perkiraan/budget/{id}', 'Asiaone\DealController@perkiraan_budget')->name('prospek.deal.perkiraan.budget');
        Route::post('/prospek/deal/perkiraan/budget/store', 'Asiaone\DealController@perkiraan_budget_store')->name('prospek.deal.perkiraan.budget.store');
        Route::get('/prospek/deal/perkiraan/budget/edit/{id}', 'Asiaone\DealController@perkiraan_budget_edit')->name('prospek.deal.perkiraan.budget.edit');
        Route::post('/prospek/deal/perkiraan/budget/edit/store', 'Asiaone\DealController@perkiraan_budget_edit_store')->name('prospek.deal.perkiraan.budget.edit.store');
        Route::delete('/prospek/deal/perkiraan/budget/edit/delete/{id}/{id_prospect}', 'Asiaone\DealController@perkiraan_budget_edit_delete')->name('prospek.deal.perkiraan.budget.edit.delete');
        Route::delete('/prospek/deal/perkiraan/budget/edit/acc/{id}/{id_prospect}', 'Asiaone\DealController@perkiraan_budget_edit_acc')->name('prospek.deal.perkiraan.budget.edit.acc');
        Route::get('/prospek/deal/invoice/{id}', 'Asiaone\DealController@invoice')->name('prospek.deal.invoice');
        Route::post('/prospek/deal/invoice/update', 'Asiaone\DealController@update')->name('prospek.deal.invoice.update');
        Route::get('/prospek/deal/invoice/delete/{id}/{id_prospect}', 'Asiaone\DealController@delete')->name('prospek.deal.invoice.delete');
        Route::get('/prospek/deal/pelunasan/{id}', 'Asiaone\DealController@pelunasan')->name('prospek.deal.pelunasan');
        Route::get('/prospek/deal/bast/{id}', 'Asiaone\DealController@bast')->name('prospek.deal.bast');
        Route::delete('/prospek/deal/delete/{id}', 'Asiaone\DealController@delete')->name('prospek.deal.delete');

        Route::get('/prospek/spk/vendor/{id}', 'Asiaone\DealController@spk_vendor')->name('prospek.deal.spk_vendor');
        Route::post('/prospek/spk/vendor/print', 'Asiaone\DealController@spk_vendor_print')->name('prospek.deal.spk_vendor.print');
